public class WP3Demo {
    public static void main(String[] args) {
        ...
        System.out.println("HeapDispatcher Poll Suresi (O(log N)): " + timeFast + " ms");
        System.out.println("NaiveDispatcher Poll Suresi (O(N))   : " + timeSlow + " ms");
    }
}