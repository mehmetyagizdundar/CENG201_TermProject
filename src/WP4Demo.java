public class WP4Demo {
    public static void main(String[] args) {
        ...
        registry.put(s1);
        System.out.println("Orijinal Yükleme: " + s1.getFileName() + " (V" + s1.getVersion() + ")");
        ...
        System.out.println("Hatali Güncelleme Sonrasi: " + current.getFileName() + " (V" + current.getVersion() + ")");
        System.out.println("Rollback İşlemi Uygulanıyor...");
        rollbackService.rollback("S-001");
        System.out.println("Rollback Sonrası Mevcut Durum: " + current.getFileName() + " (V" + current.getVersion() + ")");
    }
}
